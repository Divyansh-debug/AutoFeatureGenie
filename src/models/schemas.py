...
class EDASummary(BaseModel):
    ...
    column_info: Dict[str, Dict[str, Any]] = Field(
        ..., description="Column-wise statistics"
    )
    likely_target_column: Optional[str] = Field(
        None, description="Detected target column"
    )
...
class FeatureSuggestion(BaseModel):
    ...
    code_snippet: Optional[str] = Field(
        None, description="Python code to create the feature"
    )
    expected_impact: Optional[str] = Field(
        None, description="Expected impact on model performance"
    )
    ...
    error: Optional[str] = Field(
        None, description="Error message if suggestion generation failed"
    )
    details: Optional[str] = Field(None, description="Error details")
    raw_output: Optional[str] = Field(
        None, description="Raw output from AI if parsing failed"
    )
